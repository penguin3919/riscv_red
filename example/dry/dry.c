	...
	*) echo 'Filename must end in ".c"' >&2; exit 1;;
	...
	echo "${CC=cc} -c -DHZ=60 ${CFLAGS} $0 -o dry1.o"
	      ${CC}    -c -DHZ=60 ${CFLAGS} $0 -o dry1.o || exit 1
	echo "${CC} -DPASS2 -DHZ=60 ${CFLAGS} $0 dry1.o ${LFLAGS} -o dry2"
	      ${CC} -DPASS2 -DHZ=60 ${CFLAGS} $0 dry1.o ${LFLAGS} -o dry2 || exit 1
	./dry2 ${1-50000} 2>/dev/null
	echo "${CC=cc} -c -DREG -DHZ=60 ${CFLAGS} $0 -o dry1.o"
	      ${CC}    -c -DREG -DHZ=60 ${CFLAGS} $0 -o dry1.o || exit 1
	echo "${CC} -DPASS2 -DREG -DHZ=60 ${CFLAGS} $0 dry1.o ${LFLAGS} -o dry2r"
	      ${CC} -DPASS2 -DREG -DHZ=60 ${CFLAGS} $0 dry1.o ${LFLAGS} -o dry2r || exit 1
	./dry2r ${1-50000} 2>/dev/null
	echo "${CC=cc} -c -DHZ=60 -O ${CFLAGS} $0 -o dry1.o"
	      ${CC}    -c -DHZ=60 -O ${CFLAGS} $0 -o dry1.o || exit 1
	echo "${CC} -DPASS2 -DHZ=60 -O ${CFLAGS} $0 dry1.o ${LFLAGS} -o dry2o"
	      ${CC} -DPASS2 -DHZ=60 -O ${CFLAGS} $0 dry1.o ${LFLAGS} -o dry2o || exit 1
